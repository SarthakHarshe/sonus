...
export default function SoundBar() {
  ...
  return (
    <div className="px-4 pb-2">
      <Card className="bg-background/60 border-top relative w-full shrink-0 py-0 backdrop-blur">
        <div className="space-y-2 p-3">
          <div className="flex items-center justify-between">
            <div className="flex min-w-0 flex-1 items-center gap-2">
              <div className="bg-grad flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-md bg-gradient-to-br from-purple-500 to-pink-500">
                {track?.artwork ? (
                  <img
