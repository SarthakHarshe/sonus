    ...
    <div>
      <div onClick={handlePlay} className="cursor-pointer">
        <div className="group relative aspect-square w-full overflow-hidden rounded-md bg-gray-200 group-hover:opacity-75">
          ...
          {/* Loader */}
          <div className="group-hover: transition-opacity:opacity-100 absolute inset-0 flex items-center justify-center bg-black/50 opacity-0">
            <div className="group-hover: group-hoveer:scale-105 flex h-12 w-12 items-center justify-center rounded-full bg-black/60 transition-transform">
              {isLoading ? (
